...
function renderStats(repoStats, contributors) {
    ...
    if (!statsGrid) return; // Safety check
    ...
    const stats = [
        ...
        { label: 'Current Watching', value: repoStats.subscribers_count || 0, icon: 'eye' }
    ];
...
function renderContributors(contributors) {
    ...
    if (!contributorsGrid) return; // Safety check
